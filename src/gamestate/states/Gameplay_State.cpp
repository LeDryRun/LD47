...
Gameplay_State::Gameplay_State(Imagehandler& imagehandler, Audiohandler& audiohandler) :test_layer("test_layer") {
	...
	player.create(Point(world.width / 2, world.active_bottom - 100), 2);
...
void Gameplay_State::update(Mousey& mouse, Keyblade& keyboard, Gamepad& gamepad) {
	Duration_Check::start("-Platformer update");
...
void Gameplay_State::render(sf::RenderWindow& window) {
	Duration_Check::start("-Platformer render");
...
void Gameplay_State::update_player(Mousey& mouse, Keyblade& keyboard, Gamepad& gamepad) {
...
void Gameplay_State::render_bounds(sf::RenderWindow& window)
{
	// Create world bounds
...
void Gameplay_State::create_waves() {
...
void Gameplay_State::add_bullets() {
